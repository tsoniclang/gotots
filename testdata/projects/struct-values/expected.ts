...
export class Reserved {
    declare private readonly $goType: void;
    public __go_constructor: int32;
    public constructor($fields: {
        __go_constructor: int32;
    }) {
        this.__go_constructor = $fields.__go_constructor;
    }
}
...
export function CompositeSecondArgument(): int32 {
    return ReadXAfter(DirectValue(), new Box({
        Active: true,
        Point: new Point({
            Visible: true,
            X: 6
