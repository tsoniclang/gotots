...
test("math/big Float selected methods retain receiver identity", (): void => {
  ...
  assert.equal(Float.SetPrec(receiver, 256), receiver);
  assert.equal(Float.SetInt(receiver, NewInt(42)), receiver);
