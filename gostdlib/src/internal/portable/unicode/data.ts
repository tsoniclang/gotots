export type CaseRangeRecord = readonly [number, number, number, number, number];

export const caseRanges: readonly CaseRangeRecord[] = [
...
export type FoldPair = readonly [number, number];

export const caseOrbit: readonly FoldPair[] = [
  [0x004B, 0x006B],
  [0x0053, 0x0073],
  [0x006B, 0x212A],
  [0x0073, 0x017F],
...
export type RangeRecord = readonly [number, number, number];

export const digitRanges16: readonly RangeRecord[] = [
  [0x0030, 0x0039, 1],
  [0x0660, 0x0669, 1],
  [0x06f0, 0x06f9, 1],
  [0x07c0, 0x07c9, 1],
...
export const digitRanges32: readonly RangeRecord[] = [
  [0x104a0, 0x104a9, 1],
  [0x10d30, 0x10d39, 1],
  [0x11066, 0x1106f, 1],
  [0x110f0, 0x110f9, 1],
