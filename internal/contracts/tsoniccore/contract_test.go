...
func TestContractIsPinned(t *testing.T) {
	tests := []struct {
		...
		{SymbolViewPointer, "@tsonic/core/lang.js", "viewPointer", PhaseValue},
		{SymbolBindMemoryField, "@tsonic/core/lang.js", "bindMemoryField", PhaseValue},
		{SymbolBindMemoryRecord, "@tsonic/core/lang.js", "bindMemoryRecord", PhaseValue},
		{SymbolMemoryFieldBinding, "@tsonic/core/types.js", "MemoryFieldBinding", PhaseType},
		{SymbolBindPointer, "@tsonic/core/lang.js", "bindPointer", PhaseValue},
		{SymbolRawPointer, "@tsonic/core/types.js", "RawPointer", PhaseType},
		{SymbolToRawPointer, "@tsonic/core/lang.js", "toRawPointer", PhaseValue},
		{SymbolReinterpretRawPointer, "@tsonic/core/lang.js", "reinterpretRawPointer", PhaseValue},
		...
		{SymbolFixedArray, "@tsonic/core/types.js", "FixedArray", PhaseType},
		{SymbolMemoryArrayLayout, "@tsonic/core/lang.js", "memoryArrayLayout", PhaseValue},
		{SymbolDefaultValue, "@tsonic/core/lang.js", "defaultValue", PhaseValue},
