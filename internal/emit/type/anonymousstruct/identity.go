...
func BuildKeys(
	...
	if structType == nil {
		return Keys{}, &api.NameError{
			Reason: "anonymous-struct Go type is nil",
		}
	}
	if namedObjectIdentity == nil {
		return Keys{}, &api.NameError{
			Reason: "anonymous-struct named-object identity owner is nil",
		}
	}
	...
	return Keys{
		Fingerprint: encoded[:fingerprintHexLength],
		Artifact:    encoded,
	}, nil
}
...
func appendTypeDescriptor(
	...
	case *types.Named:
		...
		if object == nil {
			return &api.NameError{
				Reason: "anonymous-struct named field type has no declaration",
			}
		}
	...
	default:
		return &api.NameError{
			Reason: "anonymous-struct field type has no deterministic artifact key",
		}
	}
	return nil
}
