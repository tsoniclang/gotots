...
func TestRuntimeSymbolContractsArePinnedAndClosed(t *testing.T) {
	tests := []struct {
		...
		{api.RuntimeArrayZeroWith, 201, api.RuntimeModuleArray, "runtime/array.ts", "goArrayZeroWith", false, []api.RuntimeSymbol{api.RuntimeArray}},
		{api.RuntimeArrayLiteralWith, 202, api.RuntimeModuleArray, "runtime/array.ts", "goArrayLiteralWith", false, []api.RuntimeSymbol{api.RuntimeArrayZeroWith}},
		{api.RuntimeArrayCopyWith, 203, api.RuntimeModuleArray, "runtime/array.ts", "goArrayCopyWith", false, []api.RuntimeSymbol{api.RuntimeArrayZeroWith}},
		...
		{api.RuntimeSliceAppendSliceWith, 307, api.RuntimeModuleSlice, "runtime/slice.ts", "goSliceAppendSliceWith", false, []api.RuntimeSymbol{api.RuntimeSlice}},
		{api.RuntimeSliceClearWith, 308, api.RuntimeModuleSlice, "runtime/slice.ts", "goSliceClearWith", false, []api.RuntimeSymbol{api.RuntimeSlice}},
