...
func TestTargetSequenceFallthrough(t *testing.T) {
	...
	if targetSequenceFallsThrough([]tsgo.Statement{
		expressionStatement,
		returnStatement,
		expressionStatement,
	}) {
	...
	if targetSequenceFallsThrough([]tsgo.Statement{terminalIf}) {
	...
	if !targetSequenceFallsThrough([]tsgo.Statement{partialIf}) {
